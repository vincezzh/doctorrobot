...
public class Constant {
    ...
    public static final String JSON_OUTPUT = FILE_OUTPUT_BASE_PATH + "/doctors.json";
    public static final String ATTENSION_OUTPUT = FILE_OUTPUT_BASE_PATH + "/attension.txt";
